...
public class Runner1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            connector.clean();
            DbFiller filler = new CsvDbFiller(connector, GeneralConstants.CSV_FILE_NAME_WITH_INT_MARKS, EnumMark.INT_MARK);
            filler.fillDbFromFile();
            connector.printMeanMark(EnumMark.INT_MARK);
            List<Result> results = connector.getListOfSearchResults(SearchCriteria.CURRENT_MONTH_RESULTS_ASCENDING, EnumMark.INT_MARK);
